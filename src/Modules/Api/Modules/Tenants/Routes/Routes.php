...
class Routes
{
    public function routes($router): void
    {
        ...
        $router->addParamRoute('/api/tenants/{id:int}/users',   Controller::class, 'users',    ['cors', 'jwt']);
        $router->addParamRoute('/api/tenants/{id:int}/update',  Controller::class, 'update',   ['cors', 'jwt']);
        $router->addParamRoute('/api/public/tenants/{slug}',    Controller::class, 'bySlug',   ['cors']);
    }
}
